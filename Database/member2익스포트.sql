...
SET DEFINE OFF;
Insert into SCOTT.MEMBER2 (ID,PASSWD,NAME,ADDRESS,TEL,REG_DATE) values ('aa','1234','김유신','서라벌1','010-2222-3334',to_date('25/05/25','RR/MM/DD'));
Insert into SCOTT.MEMBER2 (ID,PASSWD,NAME,ADDRESS,TEL,REG_DATE) values ('bb','1234','강감찬','거란','010-3333-7777',to_date('25/05/25','RR/MM/DD'));
...
Insert into SCOTT.MEMBER2 (ID,PASSWD,NAME,ADDRESS,TEL,REG_DATE) values ('hh','1234','신유겸','개성','010-6667-8989',to_date('25/05/25','RR/MM/DD'));
