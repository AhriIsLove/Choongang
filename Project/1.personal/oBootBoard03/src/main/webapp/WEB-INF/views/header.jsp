			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown"><a
						...
						data-bs-toggle="dropdown" aria-expanded="false"> 부서 관리 </a>
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" href="/dept/list">부서 조회</a></li>
							<li><a class="dropdown-item" href="/dept/deptInForm">부서
									등록</a></li>
						</ul></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" role="button"
					...
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" role="button"
						data-bs-toggle="dropdown" aria-expanded="false"> 게시판 관리 </a>
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" href="#">게시판 조회</a></li>
							<li><a class="dropdown-item" href="#">게시판 등록</a></li>
							<li><a class="dropdown-item" href="/upLoadFormStart">upload(개인정보
									수정)</a></li>
						</ul></li>
				</ul>
			</div>
