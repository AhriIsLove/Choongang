...
<body>
	...
	<div class="container my-5 bg-warning ">
        <h2 class="text-center mb-4">emp 목록</h2>
  
        <!-- 목록 헤더 (레이블) -->
        <div class="row fw-bold py-2 border-bottom bg-primary">
            <div class="col-2">사원 코드</div>
            <div class="col-2">사원 이름</div>
            <div class="col-1">사원 ID</div>
            <div class="col-2">사원 부서</div>
            <div class="col-1">사원 Image</div>
            ...
            <c:forEach var="empDto" items="${empDtoList }" varStatus="status">
                ...
                <a href="${pageContext.request.contextPath}/emp/empDetail?emp_no=${empDto.emp_no}" class="text-decoration-none text-reset">
                    <div class="row py-2 border-bottom list-item-row">
                        <div class="col-2">${empDto.emp_no }</div>
                        <div class="col-2">${empDto.emp_name }</div>
                        <div class="col-1">${empDto.emp_id }</div>
                        <div class="col-2">${empDto.dept_name }</div>
                        <div class="col-1"><img alt="UpLoad Image1" src="${pageContext.request.contextPath}/upload/${empDto.simage}"></div>
                    </div>
                </a>
        ...
        <c:if test="${empty empDtoList}">
            <div class="row">
                <div class="col text-center py-4 text-muted">등록된 사원이 없습니다.</div>
            </div>
        </c:if>
	</div>
	<!-- 페이징 -->
